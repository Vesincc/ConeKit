...
public protocol PluginType {
    ...
    func didReceive(_ result: Result<Response, NetworkError>, target: TargetType)

    /// Called to modify a result before completion.
    func process(_ result: Result<Response, NetworkError>, target: TargetType) -> Result<Response, NetworkError>
}
...
public extension PluginType {
    ...
    func willSend(_ request: RequestType, target: TargetType) {}
    func didReceive(_ result: Result<Response, NetworkError>, target: TargetType) {}
    func process(_ result: Result<Response, NetworkError>, target: TargetType) -> Result<Response, NetworkError> { return result }
}
